...
export class MsgCreateValidator extends jspb.Message {
  ...
  getCommission():
    ...
    | undefined;
  setCommission(
    value?: cosmos_staking_v1beta1_staking_pb.CommissionRates,
  ): void;
...
export class MsgEditValidatorResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: MsgEditValidatorResponse,
  ): MsgEditValidatorResponse.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
...
export class MsgDelegateResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: MsgDelegateResponse,
  ): MsgDelegateResponse.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
...
export class MsgUndelegateResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: MsgUndelegateResponse,
  ): MsgUndelegateResponse.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
