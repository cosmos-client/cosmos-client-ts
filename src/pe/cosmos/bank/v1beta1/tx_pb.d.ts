...
export class MsgMultiSend extends jspb.Message {
  ...
  addInputs(
    value?: cosmos_bank_v1beta1_bank_pb.Input,
    index?: number,
  ...
  addOutputs(
    value?: cosmos_bank_v1beta1_bank_pb.Output,
    index?: number,
...
export class MsgMultiSendResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: MsgMultiSendResponse,
  ): MsgMultiSendResponse.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
