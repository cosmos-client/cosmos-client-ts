...
export class QueryValidatorOutstandingRewardsResponse extends jspb.Message {
  ...
  getRewards():
    ...
    | undefined;
  setRewards(
    value?: cosmos_distribution_v1beta1_distribution_pb.ValidatorOutstandingRewards,
  ): void;
...
export class QueryValidatorSlashesResponse extends jspb.Message {
  ...
  setSlashesList(
    value: Array<cosmos_distribution_v1beta1_distribution_pb.ValidatorSlashEvent>,
  ): void;
  addSlashes(
...
export class QueryDelegationTotalRewardsResponse extends jspb.Message {
  ...
  setRewardsList(
    value: Array<cosmos_distribution_v1beta1_distribution_pb.DelegationDelegatorReward>,
  ): void;
  addRewards(
