...
export class BaseVestingAccount extends jspb.Message {
  ...
  static toObject(
    ...
    msg: BaseVestingAccount,
  ): BaseVestingAccount.AsObject;
...
export class ContinuousVestingAccount extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: ContinuousVestingAccount,
  ): ContinuousVestingAccount.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
...
export class DelayedVestingAccount extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: DelayedVestingAccount,
  ): DelayedVestingAccount.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
...
export class PeriodicVestingAccount extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: PeriodicVestingAccount,
  ): PeriodicVestingAccount.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
