...
import * as ibc_core_connection_v1_connection_pb from "./connection_pb";
...
export class QueryConnectionRequest extends jspb.Message {
  ...
  static toObject(
    ...
    msg: QueryConnectionRequest,
  ): QueryConnectionRequest.AsObject;
...
export class QueryConnectionResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: QueryConnectionResponse,
  ): QueryConnectionResponse.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
...
export class QueryConnectionsRequest extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: QueryConnectionsRequest,
  ): QueryConnectionsRequest.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
...
export class QueryConnectionsResponse extends jspb.Message {
  ...
  setConnectionsList(
    value: Array<ibc_core_connection_v1_connection_pb.IdentifiedConnection>,
  ): void;
  addConnections(
  ...
  static toObject(
    includeInstance: boolean,
    msg: QueryConnectionsResponse,
  ): QueryConnectionsResponse.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
