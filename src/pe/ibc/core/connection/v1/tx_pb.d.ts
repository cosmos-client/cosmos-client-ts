...
export class MsgConnectionOpenInit extends jspb.Message {
  ...
  getCounterparty():
    ...
    | undefined;
  setCounterparty(
    value?: ibc_core_connection_v1_connection_pb.Counterparty,
  ): void;
  ...
  ): MsgConnectionOpenInit.AsObject;
...
export class MsgConnectionOpenTry extends jspb.Message {
  ...
  setCounterpartyVersionsList(
    value: Array<ibc_core_connection_v1_connection_pb.Version>,
  ): void;
...
export class MsgConnectionOpenConfirm extends jspb.Message {
  ...
  ): MsgConnectionOpenConfirm.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
