...
import * as ibc_core_commitment_v1_commitment_pb from "../../../core/commitment/v1/commitment_pb";
...
export class ClientState extends jspb.Message {
  ...
  addProofSpecs(
    value?: confio_proofs_pb.ProofSpec,
    index?: number,
  ): confio_proofs_pb.ProofSpec;
...
export class Header extends jspb.Message {
  ...
  getTrustedValidators():
    ...
    | undefined;
  setTrustedValidators(
    value?: tendermint_types_validator_pb.ValidatorSet,
  ): void;
