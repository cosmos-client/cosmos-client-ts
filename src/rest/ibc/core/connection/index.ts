...
codec.register('/ibc.core.connection.v1.Counterparty', ibc.core.connection.v1.Counterparty, ibc.core.connection.v1.Counterparty.fromObject);
codec.register('/ibc.core.connection.v1.Version', ibc.core.connection.v1.Version, ibc.core.connection.v1.Version.fromObject);
codec.register(
