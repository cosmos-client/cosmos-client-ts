...
export function validatorCommission(sdk: CosmosSDK, validatorAddress: ValAddress) {
  return new QueryApi(undefined, sdk.url).validatorCommission(validatorAddress.toString());
}

export function validatorOutstandingRewards(sdk: CosmosSDK, validatorAddress: ValAddress) {
